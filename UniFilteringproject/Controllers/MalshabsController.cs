...
namespace UniFilteringproject.Controllers
{
    public class MalshabsController : Controller
    {
        ...
        {
            return View(await _context.TheMalshabs.ToListAsync());
        }
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var malshab = await _context.TheMalshabs
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            var malshab = await _context.TheMalshabs.FindAsync(id);
            if (malshab == null)
            {
                return NotFound();
            }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            if (malshab != null)
            {
                _context.TheMalshabs.Remove(malshab);
            }
        ...
        {
            return _context.TheMalshabs.Any(e => e.Id == id);
        }
    }
}
